...
@section('css')
    ...
    <style>
        ...
        .ref-card:not(.ref-purple) .ref-list li::before {
            color: var(--color-a);
        }

        .ref-card.ref-purple .ref-list li::before {
            color: var(--color-b);
        }
...
@section('content')
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <a href="{{ route('portal.doctors.export') }}" class="btn btn-sm btn-primary">Export Doctors
                        Excel</a>
    ...
    {{-- ══════════════════════════════════════════════
         ADD / EDIT MODAL
    ══════════════════════════════════════════════ --}}
    <div class="modal fade" id="doctorModal" tabindex="-1" role="dialog" aria-labelledby="modalTitle"
         aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <form id="doctor_form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3 row">
                            <label class="col-md-4 col-form-label">Diabetes Patients in a Month <span
                        ...
                        {{-- UDCA Rx/Month --}}
                        <div class="mb-3 row">
                            <label class="col-md-4 col-form-label">UDCA Rx/Month <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-8">
                        ...
                        {{-- Sema Rx/Month --}}
                        <div class="mb-3 row">
                            <label class="col-md-4 col-form-label">Sema Rx/Month <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-8">
                        ...
                        {{-- Bilypsa Rx/Month --}}
                        <div class="mb-3 row">
                            <label class="col-md-4 col-form-label">Bilypsa Rx/Month <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-8">
                        ...
                        {{-- Linvas Rx/Month --}}
                        <div class="mb-3 row">
                            <label class="col-md-4 col-form-label">Linvas Rx/Month <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-8">
                        ...
                        {{-- Vorxar Rx/Month --}}
                        <div class="mb-3 row">
                            <label class="col-md-4 col-form-label">Vorxar Rx/Month <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="wd-sl-modalbtn">
                                ...
                                <button type="button" data-dismiss="modal"
                                        class="btn btn-outline-secondary waves-effect">Close
                                </button>
                            </div>
                        </div>
...
@section('script')
    ...
    <script>
        ...
        function resetForm() {
            ...
            if ($.fn.selectpicker) {
                try {
                    $('#govt_dropdown').val('').selectpicker('refresh');
                } catch (e) {
                }
            }
        ...
        function fillForm(d) {
            ...
            $('[name="competitor_activity"]').val(d.competitor_activity).trigger('input');
